...
- choose whether optional analytics may be used.
...
- **Analytics/performance telemetry** (if you accept optional analytics), including pseudonymous usage and performance events.
...
| Optional website analytics and speed telemetry (only if accepted) | Pseudonymous telemetry data | Art. 6(1)(a) GDPR (consent) |
...
- **Optional analytics/performance telemetry:** retained according to Vercel Analytics and Speed Insights retention settings.
...
Purpose: website hosting and optional analytics/performance telemetry if accepted.  
...
We use browser storage to persist your analytics preference (accept/decline).  
Optional analytics/performance telemetry is only activated after your consent choice.
